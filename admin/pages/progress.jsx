          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 items-start">
            ...
            <div className="col-span-12 lg:col-span-4 space-y-4">
              <article className="panel">
                ...
                <div className="text-[10px] font-mono text-neutral-400 font-semibold tracking-wider mb-2 uppercase select-none">
                    ...
                    {filteredStudents.map((student) => {
                      ...
                      return (
                        <button
                          ...
                          className={`w-full text-left p-3 hover:bg-neutral-50/50 transition duration-150 flex flex-col gap-0.5 ${
                            isSelected
                              ? "bg-neutral-50 border-l-4 border-accent pl-2"
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        {(selectedRound?.metadataTemplate?.allowVenue ||
                          ...
                          <div className="flex flex-col gap-1">
                            ...
                            {selectedRound?.predefinedVenues &&
                              selectedRound.predefinedVenues.length > 0 && (
                                <div className="flex gap-2 items-center">
                                  <Select
                                    value={
                                      selectedRound.predefinedVenues.includes(resultForm.venue)
                                        ? resultForm.venue
                                        : ""
                                    }
                                    onChange={(event) => {
                                  ...
                                  {resultForm.venue &&
                                    selectedRound.predefinedVenues.includes(resultForm.venue) && (
                                      <Button
                                        ...
                                        onClick={async () => {
                                          const updatedVenues = selectedRound.predefinedVenues.filter(
                                            (v) => v !== resultForm.venue
                                          );
                                          try {
                                            await updateProcessRound(
                                              selectedProcessId,
                                              selectedRound.id,
                                              {
                            ...
                            <div className="flex gap-2 items-center mt-1">
                              ...
                              {resultForm.venue.trim() &&
                                !selectedRound?.predefinedVenues?.includes(
                                  resultForm.venue.trim()
                                ) && (
                                  <Button
                                    type="button"
